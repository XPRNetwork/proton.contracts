...
namespace eosiosystem {
   ...
   void system_contract::deposit( const name& owner, const asset& amount )
   {
      ...
      check (checkPermission(owner, "rex")==1, "You are not authorised to use REX");  // PROTON Check Permissions
   ...
   void system_contract::buyrex( const name& from, const asset& amount )
   {
      ...
      check (checkPermission(from, "rex")==1, "You are not authorised to use REX");  // PROTON Check Permissions
   ...
   void system_contract::unstaketorex( const name& owner, const name& receiver, const asset& from_net, const asset& from_cpu )
   {
      ...
      check (checkPermission(owner, "rex")==1, "Owner is not authorised to use REX");  // PROTON Check Permissions
      check (checkPermission(receiver, "rex")==1, "Receiver is not authorised to use REX");  // PROTON Check Permissions
   ...
   void system_contract::rexexec( const name& user, uint16_t max )
   {
      ...
      check (checkPermission(user, "rex")==1, "You are not authorised to use REX");  // PROTON Check Permissions
